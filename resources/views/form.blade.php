...
<div class="container" id="form">
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action="/postKonten" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="id_kategori" id="id_kategori" required oninvalid="this.setCustomValidity('Form harap diisi semua')" oninput="setCustomValidity('')">
